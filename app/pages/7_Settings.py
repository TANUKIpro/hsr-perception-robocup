...
from components.profile_management import render_profile_management_tabs
...
def show_settings_page() -> None:
    ...
    # Profile Management (with tabs: List, Create, Import/Export)
    render_profile_management_tabs(
