...
│   │   ├── device_utils.py        # CUDA/デバイス検出
│   │   └── validation.py          # バリデーション
│   ├── capture/                   # キャプチャツール
│   │   ├── burst_capture.py       # ROS2バースト撮影
│   │   ├── capture_app.py         # キャプチャGUI
│   │   └── capture_frame.py       # 単一フレーム撮影
│   ├── annotation/                # アノテーション
